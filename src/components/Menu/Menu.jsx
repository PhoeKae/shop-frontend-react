...
const Menu = () => {
  ...
  if (loading)
    return (<div className='max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-10 sm:py-16 lg:py-20 mt-15'>
  ...
  if (error)
    return <p className="text-center text-3xl font-bold mt-20 text-red-500">Menu Error</p>

  // Filtering
  let filteredItems =
    activeTab === 'All' ? products : products.filter(item => item.category?.name === activeTab);
    ...
    <section className='mt-15'>
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-10 sm:py-16 lg:py-20">
        ...
        <div className='text-center mt-15'>
          <Link to="/menu-page" className='bg-gradient-to-b from-orange-400 to-orange-500 text-white px-5 py-4 rounded-lg md:text-lg text-md hover:scale-105 hover:to-amber-500 transition-all duration-300 cursor-pointer' >All Menus are Here.</Link>
        </div>
      </div>
    </section>
  )
