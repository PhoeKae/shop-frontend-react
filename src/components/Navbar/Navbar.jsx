  ...
  return (
    <header className=' bg-yellow-950 fixed top-0 right-0 left-0'>
      <motion.nav
        ...
        className='max-w-[1400px] mx-auto px-10 md:h-[12vh] h-[9vh] flex justify-between items-center'>
        ...
        <ul className={`flex flex-col gap-y-12 bg-orange-500/15 backdrop-blur-sm rounded-xl p-10 w-70 items-center gap-x-15 md:hidden absolute top-30 -left-full transform -translate-x-1/2 transition-all duration-500 ${showMenu ? 'left-1/2' : ''}`}>
          <li>
            <Link to="/" onClick={() => setShowMenu(false)} className='font-semibold tracking-wider text-white hover:text-orange-500'>Home</Link>
          </li>
          <li>
            <Link to="/menu-page" onClick={() => setShowMenu(false)} className='font-semibold tracking-wider text-white hover:text-orange-500'>Menu</Link>
          </li>
          <li>
            <Link to="/process" onClick={() => setShowMenu(false)} className='font-semibold tracking-wider text-white hover:text-orange-500'>Our Process</Link>
          </li>
          <li>
            <Link to="/contact" onClick={() => setShowMenu(false)} className='font-semibold tracking-wider text-white hover:text-orange-500'>Contact Us</Link>
          </li>
        </ul>
      </motion.nav>
    </header >
